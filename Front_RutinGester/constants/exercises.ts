...
export const EXERCISE_MAP = EXERCISES.reduce<Record<ExerciseDef['id'], ExerciseDef>>((acc, e) => {
  acc[e.id] = e;
  return acc;
}, {} as Record<ExerciseDef['id'], ExerciseDef>);

export function getExerciseById(id?: string | null) {
  if (!id) return undefined;
  return EXERCISE_MAP[id as ExerciseDef['id']];
}
