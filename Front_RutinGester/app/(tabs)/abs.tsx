...
const TEMPLATE_ABS = EXERCISES.filter(e => e.group === 'abs');

export default function AbsRoutineScreen() {
    const { createRoutineFromTemplate } = useRoutine();
    const handleUseTemplate = async () => {
      const routine = await createRoutineFromTemplate('Plantilla Abdominales', TEMPLATE_ABS);
      if (routine) {
  ...
  return (
    <ThemedView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <ThemedText type="title">Abdominales</ThemedText>
        <ThemedText style={styles.paragraph}>Esta plantilla de abdominales incluye ejercicios básicos para activar el core. Puedes usarla como punto de partida y luego editar o quitar ejercicios según tu progreso.</ThemedText>
